  ...
  return (
    <section id="education" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {/* Timeline container */}
        <div className="relative max-w-3xl mx-auto before:absolute before:top-2 before:bottom-2 before:left-8 before:w-[2px] before:bg-gradient-to-b before:from-violet-500 before:via-indigo-500 before:to-gray-800">
          {educationData.map((edu, idx) => (
            <div key={idx} className="relative pl-16 pb-12 last:pb-0 group">
              {/* Timeline Dot with pulse effect */}
              <div className="absolute left-[25px] top-1.5 w-[14px] h-[14px] rounded-full bg-violet-600 border-4 border-[#030712] z-10 group-hover:scale-120 transition-all duration-300 shadow-[0_0_10px_rgba(139,92,246,0.6)]">
                {edu.status && (
              ...
              {/* Timeline Card */}
              <div className="glass rounded-2xl p-6 md:p-8 border border-white/5 hover:border-violet-500/30 transition-all duration-300 shadow-lg relative group">
